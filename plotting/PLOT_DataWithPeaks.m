function [hfig] = PLOT_DataWithPeaks(Data,Data_BPM, ...
...
% PLOT_DataWithPeaks(Data,Data_BPM,file_index,datacolumns, plot_peak_numbers, plot_datacolumns_to_same_fig)
% PLOT_DataWithPeaks(Data,Data_BPM, [],[1,3]) 
...
% notice: fig_full  will create hfig structure
fig_full; % --> hfig = figure('units','pixel','outerposition',[fig_out_pos]);
