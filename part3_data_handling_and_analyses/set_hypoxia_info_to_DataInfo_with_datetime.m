...
% function DataInfo = set_hypoxia_info_to_DataInfo_with_datetime(DataInfo,  hypoxia_start_datetime, hypoxia_end_datetime)
...
DataInfo.hypoxia.end_time_index = find(DataInfo.measurement_time.datetime <= hypoxia_end_datetime,1,'last');
